<x-app-layout>
    ...
    <div class="container-fluid">
        <div class="bg-white p-4 p-md-5 shadow-sm rounded">
            ...
            <form method="POST" action="{{ route('management.users.store') }}" id="user-form">
                @csrf
                ...
                <div class="row mb-3">
                    <label for="password" class="col-md-2 col-form-label">Senha <span class="text-danger">*</span></label>
                    <div class="col-md-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-text">Busca automática via CEP.</div>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-2">
                        <input type="text" class="form-control" id="state" name="state" value="{{ old('state') }}" maxlength="2" placeholder="UF">
                    </div>
                </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Limpa as máscaras antes de enviar para o Controller
