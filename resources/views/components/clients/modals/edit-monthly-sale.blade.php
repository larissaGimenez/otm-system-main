        ...
        <div class="col-md-6 mb-3">
            <div class="form-floating">
                <input
                    ...
                    onwheel="this.blur()"
                >
                <label for="month_{{ $sale->id }}">Mês* (1–12)</label>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-6 mb-3">
            <div class="form-floating">
                <input
                    ...
                    step="0.01"
                    class="form-control"
                    id="gross_sales_value_{{ $sale->id }}"
                    name="gross_sales_value"
                    value="{{ old('gross_sales_value', $sale->gross_sales_value) }}"
                    placeholder="1000.00"
                    required
                    min="0"
                    onwheel="this.blur()"
        ...
        <div class="col-md-6 mb-3">
            <div class="form-floating">
                <input
                    ...
                    step="0.01"
                    class="form-control"
                    id="net_sales_value_{{ $sale->id }}"
                    name="net_sales_value"
                    value="{{ old('net_sales_value', $sale->net_sales_value) }}"
                    placeholder="800.00"
                    min="0"
                    onwheel="this.blur()"
                >
