        ...
        @if (Auth::user()->hasAnyRole(['admin', 'manager', 'staff']))
                    ...
                    <ul class="nav flex-column ps-4 pt-1">
                        <li class="nav-item">
                            <a href="{{ route('clients.index') }}"
                                class="nav-link text-dark small py-1 {{ request()->routeIs('clients.index') ? 'fw-bold' : '' }}">
                                Listar
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('clients.create') }}"
                                class="nav-link text-dark small py-1 {{ request()->routeIs('clients.create') ? 'fw-bold' : '' }}">
                                Criar um novo
                            </a>
                        </li>
                    </ul>
            ...
            <li class="nav-item mb-1">
                ...
                <div class="collapse {{ request()->routeIs('pdvs.*') ? 'show' : '' }}" id="pdvSubmenu">
                    <ul class="nav flex-column ps-4 pt-1">
                        <li class="nav-item"><a href="{{ route('pdvs.index') }}"
                                class="nav-link text-dark small py-1 {{ request()->routeIs('pdvs.index') ? 'fw-bold' : '' }}">Listar</a>
                        </li>
                        <li class="nav-item"><a href="{{ route('pdvs.create') }}"
                                class="nav-link text-dark small py-1 {{ request()->routeIs('pdvs.create') ? 'fw-bold' : '' }}">Criar
                                um novo</a></li>
                        <li class="nav-item"><a href="{{ route('settings.pdv.index') }}"
                                class="nav-link text-dark small py-1 {{ request()->routeIs('settings.pdv.*') ? 'fw-bold' : '' }}">Configurações</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item mb-1">
                <a class="nav-link text-dark dropdown-toggle {{ request()->routeIs('requests.*') ? '' : 'collapsed' }} {{ request()->routeIs('requests.*') ? 'active text-white' : '' }}"
                    ...
                    href="#chamadosSubmenu" data-bs-toggle="collapse" role="button"
                    aria-expanded="{{ request()->routeIs('requests.*') ? 'true' : 'false' }}">
                    ...
                    <ul class="nav flex-column ps-4 pt-1">
                        <li class="nav-item">
                            <a href="{{ route('requests.index') }}"
                                class="nav-link text-dark small py-1 {{ request()->routeIs('requests.index') ? 'fw-bold' : '' }}">
                                Kanban
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('requests.create') }}"
                                class="nav-link text-dark small py-1 {{ request()->routeIs('requests.create') ? 'fw-bold' : '' }}">
                                Abrir um novo
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('requests.archived') }}"
                                class="nav-link text-dark small py-1 {{ request()->routeIs('requests.archived') ? 'fw-bold' : '' }}">
                                Arquivados
                            </a>
                        </li>
                    </ul>
        ...
        @if (Auth::user()->hasAnyRole(['admin', 'manager']))
            ...
            <li class="nav-item mb-1">
                <a class="nav-link text-dark dropdown-toggle {{ request()->routeIs('management.teams.*') ? '' : 'collapsed' }} {{ request()->routeIs('management.teams.*') ? 'active text-white' : '' }}"
                    ...
                    href="#equipesSubmenu" data-bs-toggle="collapse" role="button"
                    aria-expanded="{{ request()->routeIs('management.teams.*') ? 'true' : 'false' }}">
                    <i class="bi bi-people-fill me-2"></i> Equipes
                </a>
                <div class="collapse {{ request()->routeIs('management.teams.*') ? 'show' : '' }}" id="equipesSubmenu">
                    <ul class="nav flex-column ps-4 pt-1">
                        <li class="nav-item"><a href="{{ route('management.teams.index') }}"
                                class="nav-link text-dark small py-1 {{ request()->routeIs('management.teams.index') ? 'fw-bold' : '' }}">Listar</a>
                        </li>
                        <li class="nav-item"><a href="{{ route('management.teams.create') }}"
                                class="nav-link text-dark small py-1 {{ request()->routeIs('management.teams.create') ? 'fw-bold' : '' }}">Criar
                                um novo</a></li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item mb-1">
                <a class="nav-link text-dark dropdown-toggle {{ request()->routeIs('areas.*') ? '' : 'collapsed' }} {{ request()->routeIs('areas.*') ? 'active text-white' : '' }}"
                    ...
                    href="#areasSubmenu" data-bs-toggle="collapse" role="button"
                    aria-expanded="{{ request()->routeIs('areas.*') ? 'true' : 'false' }}">
                    <i class="bi bi-collection-fill me-2"></i> Áreas
                </a>
                <div class="collapse {{ request()->routeIs('areas.*') ? 'show' : '' }}" id="areasSubmenu">
                    <ul class="nav flex-column ps-4 pt-1">
                        <li class="nav-item"><a href="{{ route('areas.index') }}"
                                class="nav-link text-dark small py-1 {{ request()->routeIs('areas.index') ? 'fw-bold' : '' }}">Listar</a>
                        </li>
                        <li class="nav-item"><a href="{{ route('areas.create') }}"
                                class="nav-link text-dark small py-1 {{ request()->routeIs('areas.create') ? 'fw-bold' : '' }}">Criar
                                uma nova</a></li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item mb-1">
                <a class="nav-link text-dark dropdown-toggle {{ request()->routeIs('management.users.*') ? '' : 'collapsed' }} {{ request()->routeIs('management.users.*') ? 'active text-white' : '' }}"
                    ...
                    href="#usuariosSubmenu" data-bs-toggle="collapse" role="button"
                    aria-expanded="{{ request()->routeIs('management.users.*') ? 'true' : 'false' }}">
                ...
                <div class="collapse {{ request()->routeIs('management.users.*') ? 'show' : '' }}" id="usuariosSubmenu">
                    <ul class="nav flex-column ps-4 pt-1">
                        <li class="nav-item"><a href="{{ route('management.users.index') }}"
                                class="nav-link text-dark small py-1 {{ request()->routeIs('management.users.index') ? 'fw-bold' : '' }}">Listar</a>
                        </li>
                        <li class="nav-item"><a href="{{ route('management.users.create') }}"
                                class="nav-link text-dark small py-1 {{ request()->routeIs('management.users.create') ? 'fw-bold' : '' }}">Criar
                                um novo</a></li>
                    </ul>
                </div>
            </li>
