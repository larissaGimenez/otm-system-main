        ...
        <div class="bg-white shadow-sm rounded p-4">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-4">
                <div class="d-flex align-items-center gap-3">
                    <h2 class="fw-bold mb-0 fs-3">Equipamentos</h2>
                    ...
                    <ul class="nav nav-underline border-bottom-0">
                        <li class="nav-item">
                            <a class="nav-link {{ !request('search') ? 'active fw-bold text-dark' : 'text-muted' }}"
                                ...
                                Todos <span class="small">({{ $equipments->total() }})</span>
                            </a>
                        </li>
                    </ul>
                </div>
                    ...
                    <form action="{{ route('equipments.index') }}" method="GET">
                        <div class="input-group bg-white border rounded-3 overflow-hidden">
                            ...
                            <input type="search" name="search" value="{{ request('search') }}"
                                class="form-control border-0 shadow-none ps-2" placeholder="Buscar equipamentos..."
                    ...
                    @if($equipments->isEmpty())
                        <div class="text-center py-5">
                            ...
                            @if(request('search'))
                                ...
                                <a href="{{ route('equipments.index') }}" class="btn btn-outline-secondary btn-sm mt-2">Limpar
                                    busca</a>
                            @endif
                        </div>
                    @else
                            ...
                            <table class="table table-hover align-middle mb-0">
                                <thead class="bg-light border-bottom">
                                    <tr class="text-muted small fw-bold">
                                        ...
                                        <th scope="col" class="py-3">Equipamento</th>
                                        <th scope="col" class="py-3">Tipo</th>
                                        <th scope="col" class="py-3">Status</th>
                                        <th scope="col" class="py-3">Marca</th>
                                                ...
                                                <div class="d-flex justify-content-end gap-2">
                                                    ...
                                                    <form action="{{ route('equipments.destroy', $equipment) }}" method="POST"
                                                        ...
                                                        <button type="submit"
                                                            ...
                                                            onclick="return confirm('Excluir este equipamento?');">
