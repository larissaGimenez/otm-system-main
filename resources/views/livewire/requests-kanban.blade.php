                ...
                @foreach($statuses as $status)
                    <div x-data="{ expanded: true }" class="h-100">
                        ...
                        >
                            ...
                            <div
                                class="p-3 border-bottom bg-white rounded-top flex-shrink-0"
                            ...
                            <div
                                class="kanban-column-body p-2 flex-grow-1 overflow-auto custom-scrollbar"
                                data-status="{{ $status->value }}"
                                x-bind:style="expanded ? 'display:block' : 'display:none'"
                            >
                                @forelse($requestsByStatus[$status->value] as $requestItem)
                                    <div class="card shadow-sm mb-2 kanban-card border-0"
                                        ...
                                        <div class="card-body p-3">
                                            <div class="d-flex justify-content-between mb-2">
                                                ...
                                                @if($requestItem->due_at)
                                                    <span class="badge {{ $requestItem->due_at->isPast() ? 'bg-danger' : 'bg-info' }} rounded-1 fw-normal"
                                                          style="font-size:.7rem;">
                            ...
                            <div
                                class="kanban-closed-content"
                                x-bind:style="expanded ? 'display:none' : 'display:flex'"
                            >
