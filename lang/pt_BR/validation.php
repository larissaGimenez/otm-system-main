...
return [
    ...
    'attributes' => [
        ...
        'equipment_status_id' => 'status do equipamento',
    ...
    'custom' => [
        'photos.*' => [
            'mimes' => 'O formato de uma das fotos não é suportado (use JPG, PNG ou WEBP).',
            'max' => 'Uma das fotos ultrapassa o limite de 2MB.',
        ],
    ],
];
